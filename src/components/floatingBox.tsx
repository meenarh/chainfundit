    ...
    >
      ...
      <div className=" mt-5 flex flex-row justify-between gap-3 font-bold text-base font-dmSans text-center">
        <Link
          ...
          className="w-[90px] shadow-5xl py-2 font-bold text-base font-dmSans text-chainGreen hover:text-white bg-white hover:bg-chainGreen border-2 border-chainGreen rounded-lg"
        >
          View All
        </Link>
        <Link
